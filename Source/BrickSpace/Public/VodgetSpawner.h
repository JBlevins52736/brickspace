...
// Delegate declarations - must be before the class
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnSpawnByNameRequested, const FString&, ShortName);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnBrickSpawned, AActor*, SpawnedActor, const FString&, ShortName);
